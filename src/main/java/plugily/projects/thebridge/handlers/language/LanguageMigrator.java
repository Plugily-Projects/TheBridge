...
public class LanguageMigrator {
  ...
  private void configUpdate() {
    ...
    Bukkit.getConsoleSender().sendMessage(ChatColor.YELLOW + "[thebridge] System notify >> Your config file is outdated! Updating...");
    ...
    plugin.reloadConfig();
    Bukkit.getConsoleSender().sendMessage(ChatColor.GREEN + "[thebridge] [System notify] Config updated, no comments were removed :)");
    Bukkit.getConsoleSender().sendMessage(ChatColor.GREEN + "[thebridge] [System notify] You're using latest config file version! Nice!");
  }
  ...
  private void languageFileUpdate() {
    ...
    Bukkit.getConsoleSender().sendMessage(ChatColor.YELLOW + "[thebridge] [System notify] Your language file is outdated! Updating...");
    ...
    if (NumberUtils.isNumber(config.getString("File-Version-Do-Not-Edit"))) {
      ...
      Bukkit.getConsoleSender().sendMessage(ChatColor.RED + "[thebridge] [System notify] Failed to parse language file version!");
    }
    ...
    Bukkit.getConsoleSender().sendMessage(ChatColor.GREEN + "[thebridge] [System notify] Language file updated! Nice!");
    Bukkit.getConsoleSender().sendMessage(ChatColor.GREEN + "[thebridge] [System notify] You're using latest language file version! Nice!");
  }
