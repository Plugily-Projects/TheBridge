...
public class SetupInventory {
  ...
  private void prepareGui() {
    this.gui = new Gui(plugin, 4, "thebridge Arena Setup");
  ...
  private void sendProTip(Player p) {
    ...
    switch (rand) {
      ...
      case 1:
        ...
        break;
      case 2:
        p.sendMessage(chatManager.colorRawMessage("&e&lTIP: &7We are open source! You can always help us by contributing! Check https://github.com/Plugily-Projects/thebridge"));
        break;
      case 3:
        p.sendMessage(chatManager.colorRawMessage("&e&lTIP: &7Need help? Check wiki &8https://wiki.plugily.xyz/minecraft/thebridge &7or discord https://discord.gg/UXzUdTP"));
        break;
      case 4:
        p.sendMessage(chatManager.colorRawMessage("&e&lTIP: &7Suggest new ideas for the plugin or vote on current ones! https://app.feedbacky.net/b/thebridge"));
        break;
      default:
        break;
    }
